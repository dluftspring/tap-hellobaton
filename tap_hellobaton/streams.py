...
class ExternalTasks(hellobatonStream):
    """Define custom stream."""
    name = 'external_tasks'
    path = '/external_tasks/'
    primary_keys = ['id']
    schema_filepath = SCHEMAS_DIR / 'external_tasks.json'

class MilestoneFeedback(hellobatonStream):
    """Define custom stream."""
    name = 'milestone_feedback'
    path = '/milestone_feedback/'
    primary_keys = ['id']
    schema_filepath = SCHEMAS_DIR / 'milestone_feedback.json'

class TaskDeliverables(hellobatonStream):
    """Define custom stream."""
    name = 'task_deliverables'
    path = '/task_deliverables/'
    primary_keys = ['id']
    schema_filepath = SCHEMAS_DIR / 'task_deliverables.json'

class ProjectPhases(hellobatonStream):
    """Define custom stream."""
    name = 'project_phases'
    path = '/project_phases/'
    primary_keys = ['id']
    schema_filepath = SCHEMAS_DIR / 'project_phases.json'